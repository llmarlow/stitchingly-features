...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post features_url, params: { feature: { description: @feature.description, title: @feature.title } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { description: @feature.description, title: @feature.title } }
